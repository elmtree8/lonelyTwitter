...
public class ElasticsearchTweetController {
    ...
    // https://github.com/searchbox-io/Jest/blob/master/jest/README.md 2/23/16
    protected static List stringSearch( String query) {
        verifyClient();
        ...
        try {
            ...
            if (execute.isSucceeded()) {
                // Return our list of tweets
                List<NormalTweet> returned_search = execute.getSourceAsObjectList(NormalTweet.class);
